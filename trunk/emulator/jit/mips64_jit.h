...
Many optimization chances exist.
...
static forced_inline int mips64_jit_tcb_local_addr(mips64_jit_tcb_t * block, m_va_t vaddr, u_char ** jit_addr)
{
...
static forced_inline int mips64_jit_tcb_match(cpu_mips_t * cpu, mips64_jit_tcb_t * block, m_va_t vaddr)
{
    m_va_t vpage;
