...
static int cache_op(cpu_mips_t * cpu, mips_insn_t insn)
{
    ...
    if (unlikely(mips64_get_cpumode(cpu) == MIPS_USER_MODE))
    {
        ASSERT(0, "eret_op cpu->pc %x\n", cpu->pc);
        //goto err_addr;
    }
#endif
